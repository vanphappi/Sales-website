                            ...
                            <div class="row" style="width: 110%;">
                                ...
                                <div class="col-md-4 col-sm-6 col-6">
                                    <div class="input-group number-spinner">
                                        ...
                                        <input type="text" id="sll" class="form-control text-center" value="{{$product->qty}}" readonly="readonly" style="background-color: rgb(254, 172, 184)">
                                        <span class="input-group-btn">
                                ...
                                <div class="col-md-5">
                                    <span id="sanco" class="num-available-product">{{$product->options->status}}</span>
                                    sản phẩm có sẵn
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="row button-buying-product">
                            ...
                            <button id="mh" onclick="return c()" class="col-md-6 col-sm-12 btn-buynow" type="submit" >Mua hàng</button>
