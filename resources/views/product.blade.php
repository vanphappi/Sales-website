                            ...
                            <div class="row" style="width: 110%;">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="input-group number-spinner">
                                        ...
                                        <input id="sll2" name="qty" type="text" class="form-control text-center quantity" value="1" readonly="readonly" style="background-color: rgb(254, 172, 184)">
                                        <span class="input-group-btn">
                                ...
                                <div class="col-md-5">
                                    <span id="sanco2" class="num-available-product">{{$productinfo->product_status}}</span>
                                    sản phẩm có sẵn
                                </div>
                            </div>
                        </div>
