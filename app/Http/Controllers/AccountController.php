...
WHERE tbl_order.order_id=tbl_order_details.order_id and tbl_product.product_id=tbl_order_details.product_id and users.id=tbl_order.customer_id and tbl_product.brand_id=tbl_brand.brand_id and tbl_category_product.category_id=tbl_product.category_id and users.id='$user' order by tbl_order.order_id DESC
            ");
    }
